from datawarehouse.data_utils import get_conn_cursor, close_conn_cursor, create_shema, create_table, get_video_ids
from datawarehouse.data_loading import load_data
from datawarehouse.data_loading import insert_rows, update_rows, delete_rows
    ...
    try:
        ...
        for row in rows:
            ...
            if len(table_ids) == 0:
                ...
                insert_rows(cur,schema,transformed_row)
            else:
                transformed_row = transform_data(row)
